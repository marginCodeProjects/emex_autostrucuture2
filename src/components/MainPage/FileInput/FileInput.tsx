...
const FileUploadPage: React.FC<IFileUploadPageProps> = ({ setFile }) => {
    ...
    const props: UploadProps = {
        ...
        action: 'https://api-dev.autostructure.ru/v1/files/upload_file',
        onChange(info) {
    ...
    return (
        <>
            ...
            <a href='https://api-dev.autostructure.ru/v1/files/get_shablon' className={`${styles.inter__medium} ${styles.downloadTemplate}`}>{texts[language].downloadTemplate}</a>
        </>
    );
};
